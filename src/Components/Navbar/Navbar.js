...
function Navbar() {
    ...
    return (
        <>
            ...
            <div className="mobMenu absolute top-20 left-0 hidden list-none px-10 mx-5 py-5 backdrop-blur rounded-3xl border border-gray-100 bg-slate-50 bg-opacity-50" >
                {links.map((link, index) => {
                    return (
